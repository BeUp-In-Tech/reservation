...
from sqlalchemy import String, Text, DateTime, ForeignKey, Numeric, Boolean, Integer, Enum, SmallInteger, Time, text
...
class BookingStatusHistory(Base):
    ...
    from_status: Mapped[str | None] = mapped_column(BOOKING_STATUS_ENUM, nullable=True)
    to_status: Mapped[str] = mapped_column(BOOKING_STATUS_ENUM, nullable=False)
